...
|----------------------------------------------------------------------
|
| This controller handles requests related to the 'Cars' post type.
| It interacts with the CarsModel to fetch data and loads the 
...
class CarsController {
    ...
    */
    public function __construct() {
        require_once MVC_PLUGIN_PATH . 'app/Models/CarsModel.php';
    ...
    |----------------------------------------------------------------------
    |
    | Loads the archive page for 'Cars' by fetching all related posts.
    ...
    */
    ...
    |----------------------------------------------------------------------
    |
    | Loads a single 'Cars' post page by fetching data based on ID.
