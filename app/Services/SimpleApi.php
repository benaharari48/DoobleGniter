...
|----------------------------------------------------------------------
| This file registers custom REST API endpoints for the Simple theme.
...
class Simple_API_Controller {
    ...
    public function register_api_routes() {
        $service_lowercase = strtolower('Simple'); // Convert the service to lowercase before using
